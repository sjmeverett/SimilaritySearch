...
import metricspaces.update.common.VantagePointList;
 ...
 *
 */
public class VantagePointTreeIndex extends AbstractIndex implements ResultCollectorIndex {
	 ...
	 * @throws IOException
	 */
	public VantagePointTreeIndex(LargeBinaryFile file, Progress progress) throws IOException {
		super(file);
	 ...
	 * @throws IOException
	 */
	public VantagePointTreeIndex(String path, int size, String descriptorPath, String metricName, Progress progress) throws IOException {
		super(path, AbstractIndex.VP_TREE, size, descriptorPath, metricName);

		this.optimise = true;
		this.progress = progress;
		
		file.resize(dataOffset + size * NODE_SIZE);
	}
